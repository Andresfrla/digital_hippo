...
function ReceiptEmail(_a) {
    ...
    var total = products.reduce(function (acc, curr) { return acc + curr.price; }, 0) + constants_1.transactionFee;
...
var ReceiptEmailHtml = function (props) { return (0, components_1.render)(React.createElement(ReceiptEmail, __assign({}, props))); };
