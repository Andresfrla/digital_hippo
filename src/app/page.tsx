...
const perks = [
  {
    ...
    Icon: ArrowDownIcon,
    description: "Get you assets delivered to you email in seconds and dowload rigth away",
  },
  {
    name: "Guarantieed Quality",
    Icon: CheckCircle,
    description: "Every asset on our platagorm is verified by our team to ensure our highest quality standars. Not Happy? We offer a 30-day refund guaranteed",
  },
  {
    name: "For the planet",
    Icon: Leaf,
    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center macx">
        ...
        <p className="mt-6 text-lg max-w-prose text-muted-foreground">
          ...
          plataform is verified by our team to ensure our 
